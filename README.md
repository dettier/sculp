...
* [Static functions](#static-functions)
    + [`validate()`](#validate)
    + [`tryValidate()`](#try-validate)
    + [`getSchemeValue()`](#get-scheme-value)
    + [`getFieldName()`](#get-field-name)
    + [`getFieldPresence()`](#get-field-presence-value)
    + [`getInitial()`](#get-initial)
    + [`getSubScheme()`](#get-sub-scheme)
    + [`setDefaultOptions()`](#set-default-options)
* [Sculp class](#sculp-class)
    + [`constructor()`](#sculp-constructor)
    + [`validate()`](#sculp-validate)
    + [`tryValidate()`](#sculp-try-validate)
    + [`getValue()`](#sculp-get-value)
    + [`setValue()`](#sculp-set-value)
    + [`setField()`](#sculp-set-field)
    + [`setFields()`](#sculp-set-fields)
    + [`getFieldState()`](#sculp-get-field-state)
    + [`getSchemeValue()`](#sculp-get-scheme-value)
    + [`getFieldName()`](#sculp-get-field-name)
    + [`getFieldPresence()`](#sculp-get-field-presence-value)
